                  ...
                  {Array.from({ length: Math.min(5, totalPages) }, (_, i) => {
                    ...
                    return (
                      <button
                        ...
                        className={`min-w-[36px] cursor-pointer px-3 py-2 text-sm font-medium rounded-lg transition-all duration-200 ${pageNumber === pageNum
      ...
      {previewImageUrl && (
        ...
        >
          ...
          >
            ...
            <button
              onClick={() => setPreviewImageUrl(null)}
              className="cursor-pointer absolute -top-12 right-0 p-2 bg-white/10 hover:bg-white/20 text-white rounded-full"
            >
              <X className="w-6 h-6" />
            </button>
            ...
            <a
              ...
              className="absolute -bottom-12 left-1/2 -translate-x-1/2 px-4 py-2 bg-white/10 hover:bg-white/20 text-white rounded-lg flex items-center gap-2 text-sm"
              onClick={(e) => e.stopPropagation()}
            >
