        ...
        <div className="space-y-6 bg-gradient-to-br from-slate-50 to-purple-50/30 min-h-screen">
            ...
            <div className="relative w-full h-96">
                ...
                <div className="absolute top-6 right-6 flex gap-2">
                    ...
                    <span className="px-4 py-2 text-sm font-semibold rounded-full border bg-white/20 text-white backdrop-blur-sm border-white/30">
                ...
                <div className="absolute bottom-8 left-8 text-white space-y-3">
                    ...
                    <div className="flex gap-2">
                        <span className="px-3 py-1.5 text-sm font-medium rounded-full bg-purple-400 backdrop-blur-md border border-purple/30">
