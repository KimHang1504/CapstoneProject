...
export default function VoucherScan({ venueLocationId }: Props) {
    ...
    return (
        <div className="space-y-4 sm:space-y-5">
            {/* QR Scanner */}
            <div className="relative rounded-xl sm:rounded-2xl overflow-hidden border-2 border-gray-200 bg-black">
            ...
            {code && (
                <div className="p-3 sm:p-4 rounded-xl border border-gray-200 bg-linear-to-br from-gray-50 to-white">
